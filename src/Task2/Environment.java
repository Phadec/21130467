...
public class Environment {
	...
	public void step() {
		...
		if ((es.getLocationState(LOCATION_A).equals(LocationState.CLEAN)
				&& (es.getLocationState(LOCATION_B).equals(LocationState.CLEAN)
				&& (es.getLocationState(LOCATION_C).equals(LocationState.CLEAN))
				&& (es.getLocationState(LOCATION_D).equals(LocationState.CLEAN)))))
